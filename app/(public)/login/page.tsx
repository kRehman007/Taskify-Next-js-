...
const LoginPage = () => {
  ...
  return (
    <div className="flex justify-center mt-24 min-h-screen  bg-gray-200  px-4">
      <div className="max-w-md w-full h-[max-content] bg-white text-black shadow-xl rounded-lg p-8">
